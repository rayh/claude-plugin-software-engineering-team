---
name: review
description: Run a parallel review of recent changes using specialist agents
disable-model-invocation: true
argument-hint: "[scope: path, branch, or 'staged']"
---

## Current changes to review

### If scope is "staged" or not provided:
